...
from django.contrib import messages  # Adicionado messages para alertas
...
def criar_agendamento(request):
        ...
        if erros:
            ...
            try:
                ...
                if resultado["status"] == "sucesso":
                    # Salva a mensagem de sucesso e REDIRECIONA para evitar reenvio
    ...
    # A busca dos dados do histórico e GET permanecem iguais
